...
<div class="py-5">
	<div class="container">
	    ...
	    $APPLICATION->IncludeFile(
          SITE_DIR."local/include/tizer-1.php",
          Array(),
          Array("MODE"=>"html")
        );
        ?></div>
		<div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
			<?
	    $APPLICATION->IncludeFile(
          SITE_DIR."local/include/tizer-2.php",
          Array(),
          Array("MODE"=>"html")
        );
        ?></div>
		...
		<?
	    $APPLICATION->IncludeFile(
          SITE_DIR."local/include/tizer-3.php",
          Array(),
          Array("MODE"=>"html")
        );
        ?>
